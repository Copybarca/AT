  ...
  return (
    <section>
      ...
      <div className="detail-facts">
        <article><small>Контент</small><strong>{book.contentStatus === 'complete' ? 'Загружен полностью' : 'Загружается'}</strong></article>
      ...
      <div className="pipeline-card">
        ...
        <div className="pipeline-steps">
          <div className="pipeline-step complete"><i className="pi pi-check" /><span><strong>1. Извлечение</strong><small>{book.totalFragments} фрагментов · {book.imageCount} изображений</small></span></div>
